...
database = 'stock_master_test'                 # 'stock_master_test'   # sys.argv[1]
db_write_method = 'pg_copy'                # 'pandas' / 'stringio' / 'pg_copy'  # sys.argv[2]
#database = sys.argv[1]                 # 'stock_master_test'   # sys.argv[1]
#db_write_method = sys.argv[2]                # 'pandas' / 'stringio' / 'pg_copy'  # sys.argv[2]
