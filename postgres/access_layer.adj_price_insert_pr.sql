/******************************************************************************
* 
* INSERT ADJUSTED PRICES TO ACCESS_LAYER
* If a stock has had a split or dividend payment, price data is grabbed
* using the "access_layer.adj_price_fn" (full history), else the "iex.shareprices_daily"
* table (update data only, specified by the start_date and end_date).
* 
* If a stock has had a split or dividend payment, updated adjusted close
* prices are inserted via the "on conflict, on constraint, do update set"
* functionality
* 
******************************************************************************/

--call access_layer.insert_adj_price(sym => 'AAPL', start_date => '2022-02-01', end_date => '2022-02-28');
