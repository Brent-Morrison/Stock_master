/******************************************************************************
* 
* access_layer.daily_price_ts_fn
* 
* DESCRIPTION:
...
select * from access_layer.daily_price_ts_fn(valid_year_param_ => 2021, nonfin_cutoff_ => 900, fin_cutoff_ => 100);

drop function access_layer.daily_price_ts_fn;

create or replace function access_layer.daily_price_ts_fn
